                    ...
                    <div id="orderItems" class="mt-3">
                        ...
                        if (Yii::$app->request->isPost && isset($order['OrderItems'])) {
                            ...
                            foreach ($order['OrderItems'] as  $key => $orderItem) {
                                ...
                                echo '</div>';
                                echo '<div class="col-2">';
                                echo '<label class="control-label">Cost</label>';
                                echo '<input type="number" class="form-control variant-cost" name="Orders[OrderItems][' . $key . '][variant_cost]" value="' . $orderItem['variant_cost'] . '" min="1">';
                                echo '</div>';
                                echo '<div class="col-2">';
                                echo '<input type="text" class="form-control variant-price" name="Orders[OrderItems][' . $key . '][variant_price]" value="' . $orderItem['variant_price'] . '">';
                                echo '</div>';
                                echo '<div class="col-2">';
                        ...
                        if (!Yii::$app->request->isPost) {
                            ...
                            foreach ($model->orderItems as $key => $orderItem) {
                                ...
                                echo '<div class="col-2">';
                                echo '<label class="control-label">cost</label>';
                                echo '<input type="text" class="form-control variant-cost" name="Orders[OrderItems][' . $key . '][variant_cost]" value="' . $orderItem->cost . '" >';
                                echo '</div>';
                                echo '<div class="col-2">';
                                echo '<label class="control-label">price</label>';
                                echo '<input type="text" class="form-control variant-price" name="Orders[OrderItems][' . $key . '][variant_price]" value="' . $orderItem->price . '" >';
                                echo '</div>';
                                echo '<div class="col-2">';
                                echo '<button class="btn btn-danger btn-sm delete-variant-btn">Delete</button>';
                                echo '</div>';
